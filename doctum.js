...
(function(root) {
    ...
    var bhIndex = null;
    var rootPath = '';
    var treeHtml = '<ul><li data-name="namespace:" class="opened"><div style="padding-left:0px" class="hd"><span class="icon icon-play"></span><a href="[Global_Namespace].html">[Global Namespace]</a></div><div class="bd"><ul><li data-name="class:Stringable" class="opened"><div style="padding-left:26px" class="hd leaf"><a href="Stringable.html">Stringable</a></div></li></ul></div></li><li data-name="namespace:Dtion" class="opened"><div style="padding-left:0px" class="hd"><span class="icon icon-play"></span><a href="Dtion.html">Dtion</a></div><div class="bd"><ul><li data-name="namespace:Dtion_Contracts" class="opened"><div style="padding-left:18px" class="hd"><span class="icon icon-play"></span><a href="Dtion/Contracts.html">Contracts</a></div><div class="bd"><ul><li data-name="class:Dtion_Contracts_Dtionable" ><div style="padding-left:44px" class="hd leaf"><a href="Dtion/Contracts/Dtionable.html">Dtionable</a></div></li></ul></div></li><li data-name="namespace:Dtion_Exceptions" class="opened"><div style="padding-left:18px" class="hd"><span class="icon icon-play"></span><a href="Dtion/Exceptions.html">Exceptions</a></div><div class="bd"><ul><li data-name="class:Dtion_Exceptions_CriterionDoesntMatchException" ><div style="padding-left:44px" class="hd leaf"><a href="Dtion/Exceptions/CriterionDoesntMatchException.html">CriterionDoesntMatchException</a></div></li></ul></div></li><li data-name="class:Dtion_Dtion" class="opened"><div style="padding-left:26px" class="hd leaf"><a href="Dtion/Dtion.html">Dtion</a></div></li><li data-name="class:Dtion_DtionList" class="opened"><div style="padding-left:26px" class="hd leaf"><a href="Dtion/DtionList.html">DtionList</a></div></li></ul></div></li></ul>';
    ...
    var searchIndex = [
                        {"type":"Namespace","link":"[Global_Namespace].html","name":"","doc":"Namespace "},{"type":"Namespace","link":"Dtion.html","name":"Dtion","doc":"Namespace Dtion"},{"type":"Namespace","link":"Dtion/Contracts.html","name":"Dtion\\Contracts","doc":"Namespace Dtion\\Contracts"},{"type":"Namespace","link":"Dtion/Exceptions.html","name":"Dtion\\Exceptions","doc":"Namespace Dtion\\Exceptions"},                    {"type":"Interface","link":"Stringable.html","name":"Stringable","doc":"<p>Interface to store stringable elements in Dtion</p>"},
                                {"type":"Method","fromName":"Stringable","fromLink":"Stringable.html","link":"Stringable.html#method___toString","name":"Stringable::__toString","doc":"<p>Implicitely implements PHP Stringable interface\nfor PHP&lt;=8.0 .</p>"},
                                                        ...
                                                        {"type":"Class","fromName":"Dtion\\Contracts","fromLink":"Dtion/Contracts.html","link":"Dtion/Contracts/Dtionable.html","name":"Dtion\\Contracts\\Dtionable","doc":"<p>This class stores the simplest form of a a condition\n(lower and upper boundaries) and a result.</p>"},
        ...
        {"type":"Method","fromName":"Dtion\\Contracts\\Dtionable","fromLink":"Dtion/Contracts/Dtionable.html","link":"Dtion/Contracts/Dtionable.html#method_fromArray","name":"Dtion\\Contracts\\Dtionable::fromArray","doc":""},
        {"type":"Method","fromName":"Dtion\\Contracts\\Dtionable","fromLink":"Dtion/Contracts/Dtionable.html","link":"Dtion/Contracts/Dtionable.html#method_toArray","name":"Dtion\\Contracts\\Dtionable::toArray","doc":""},
        {"type":"Method","fromName":"Dtion\\Contracts\\Dtionable","fromLink":"Dtion/Contracts/Dtionable.html","link":"Dtion/Contracts/Dtionable.html#method_toJson","name":"Dtion\\Contracts\\Dtionable::toJson","doc":""},
        ...
        {"type":"Method","fromName":"Dtion\\Contracts\\Dtionable","fromLink":"Dtion/Contracts/Dtionable.html","link":"Dtion/Contracts/Dtionable.html#method___toString","name":"Dtion\\Contracts\\Dtionable::__toString","doc":""},
        ...
        {"type":"Method","fromName":"Dtion\\Dtion","fromLink":"Dtion/Dtion.html","link":"Dtion/Dtion.html#method_isSerializedClosure","name":"Dtion\\Dtion::isSerializedClosure","doc":"<p>Check if given value is a SerializableClosure</p>"},
        ...
        {"type":"Method","fromName":"Dtion\\Dtion","fromLink":"Dtion/Dtion.html","link":"Dtion/Dtion.html#method_toSerializableArray","name":"Dtion\\Dtion::toSerializableArray","doc":"<p>Get the instance as a serializable array.</p>"},
        ...
        {"type":"Method","fromName":"Dtion\\DtionList","fromLink":"Dtion/DtionList.html","link":"Dtion/DtionList.html#method_toSerializableArray","name":"Dtion\\DtionList::toSerializableArray","doc":"<p>Get the instance as a serializable array.</p>"},
